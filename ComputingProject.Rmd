...
---
When you are connecting to the pH meter, make sure to locate the serial port that is connected to the pH meter. That serial port will be added to the line of code where is says "ser".
